...
bokeh_process = subprocess.Popen(["bokeh", "serve", "--allow-websocket-origin=flokeh-bokeh-flask.a3c1.starter-us-west-1.openshiftapps", "--host=flokeh-bokeh-flask.a3c1.starter-us-west-1.openshiftapps.com", "--host=*", "--address=0.0.0.0", "--use-xheaders", "bokeh_plot.py"],stdout=subprocess.PIPE)
