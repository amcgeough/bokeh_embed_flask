...
bokeh_process = subprocess.Popen(["bokeh", "serve", "--allow-websocket-origin=flokeh3-bokeh-flask.a3c1.starter-us-west-1.openshiftapps:8080", "--port=8080", "--use-xheaders", "bokeh_plot.py"],stdout=subprocess.PIPE)
